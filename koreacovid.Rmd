...
In the Chi squared the p-value is 0.0012 is less than 0.05 which means we reject the null hypothesis. In the Fisher Test the p-value is 0.0009 which means odds are males in Korea are 2.3 times more likely to die than females.   
